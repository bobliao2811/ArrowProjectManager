//公共函数类
define(['../scripts/pageScripts/common/common.css'],function(){
	var m = function(_config){
		...
		this.initModul = function(_callBack){
			...
			//<!--command:combineRequire-->
			using(['../scripts/pageScripts/common/console/index.js','../scripts/pageScripts/common/window/index.js','../scripts/pageScripts/common/eventController/eventController.js'],function(_console,_window,_eventController){
				...
				//-->
				self.window = _window;
				self.eventController = _eventController;
				self.eventController.init();
				//<!--debug
		...
		window.eec = this.eec = new _eventController();
		eec.init();
