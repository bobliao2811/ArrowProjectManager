//欢迎界面
define(['scripts/pageScripts/moduls/welcome/index.css','scripts/pageScripts/moduls/welcome/index.html'],function(_css,_html){
        ...
        this.bindEvents = function(){
            ...
            //下一步按钮
             this.html.find('[data-event=beginUse]').click(function(){
                ...
                ac.runMainFunc('wsm','isExist',{path:self.html.find('[data-id=forder]').val()},function(_result){
                     ac.clearLoad();
                        ...
                        var workSpaceWindow = new ac.window({
                          ...
                          buttons:{
                              ...
                              yesCall:function(){
                                  ...
                                  ac.runMainFunc('wsm','createArrowConfigInC',args,function(_result){
                                    ac.clearLoad();
