//工程/项目选择界面
define(['scripts/pageScripts/moduls/projectManager/newProject/index.css','scripts/pageScripts/moduls/projectManager/newProject/index.html'],function(_css,_html){
    var m = function(_config){
        ...
        this.bindEvents = function(){
            ...
            this.html.find('.selectDev').click(function(){
                self.html.find('.selectDev').removeClass('selected');
                self.html.find('.selectDev').removeClass('blue');
                $(this).addClass('selected').addClass('blue');
                self.devMode = $(this).attr('data-value');
            });
        }
